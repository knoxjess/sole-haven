...
const Wrapper = styled.div`
    padding: 50px;
    display: flex;
    ${mobile({ padding: "10px", flexDirection: "column" })} /* Adjusted padding for mobile */
`;
...
const Image = styled.img`
    ...
    height: 90vh;
    object-fit: cover;
    ${mobile({ height: "40vh" })} /* Adjusted height for mobile */
`;
const InfoContainer = styled.div`
    flex: 1;
    padding: 0px 50px;
    margin-top: 180px; /* Added margin to move the info down */
    ${mobile({ padding: "10px" })} /* Adjusted padding for mobile */
`;
...
const Price = styled.span`
    font-weight: 100;
    font-size: 40px;
    ${mobile({ marginBottom: "20px" })} /* Adjusted margin for mobile
`;
